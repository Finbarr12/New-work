...
exports.ResetPasssword = exports.ForgotPassword = exports.SignInadmin = exports.SignUpAdmin = void 0;
...
const SignInadmin = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const Checkpass = yield bcrypt_1.default.compare(password, adminInfo.password);
        if (!Checkpass) {
...
const ForgotPassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.status(200).json({
            messge: `PIN sent to ${user === null || user === void 0 ? void 0 : user.email}`,
        });
    }
    catch (error) {
        return res.status(400).json({
...
const ResetPasssword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { email, pin, newPassword } = req.body;
        const user = yield AdminModel_1.default.findOne({ email, passwordResetPin: pin });
        if (!user) {
